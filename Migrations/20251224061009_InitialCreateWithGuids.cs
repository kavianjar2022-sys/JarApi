        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedStartTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    FixedEndTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    FixedBreakMinutes = table.Column<int>(type: "int", nullable: true),
                    WorkingDaysMask = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsGlobalAccess = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotationStartIndex = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_ShiftDefinitions_ShiftDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftRotationSegments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftRotationSegments_ShiftDefinitions_ShiftDefinitionId",
                        column: x => x.ShiftDefinitionId,
                        principalTable: "ShiftDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanView = table.Column<bool>(type: "bit", nullable: false),
                    CanConfigure = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleWidgets", x => new { x.RoleId, x.WidgetId });
                    table.ForeignKey(
                        name: "FK_RoleWidgets_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleWidgets_Widgets_WidgetId",
                        column: x => x.WidgetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleCompanies", x => new { x.UserId, x.RoleId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_UserRoleCompanies_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoleCompanies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleUnits", x => new { x.UserId, x.RoleId, x.UnitId });
                    table.ForeignKey(
                        name: "FK_UserRoleUnits_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoleUnits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoleUnits_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleWidgets_WidgetId",
                table: "RoleWidgets",
                column: "WidgetId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_ShiftDefinitionId",
                table: "ShiftAssignments",
                column: "ShiftDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_UserId_StartDate_EndDate",
                table: "ShiftAssignments",
                columns: new[] { "UserId", "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ShiftRotationSegments_ShiftDefinitionId",
                table: "ShiftRotationSegments",
                column: "ShiftDefinitionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoleUnits_RoleId",
                table: "UserRoleUnits",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRoleUnits_UnitId",
                table: "UserRoleUnits",
                column: "UnitId");
        }
